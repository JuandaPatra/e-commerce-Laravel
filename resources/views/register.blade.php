            ...
            <h1 class="text-center">Register</h1>
                <form action="/register" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="exampleInputPassword1" name="password" value="{{old('email')}}" >
                    </div>
                    <!-- <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Re-type Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword1" name="re-password">
                    </div>
